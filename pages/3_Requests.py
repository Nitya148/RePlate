...
def render_request(r, role):
    ...
    with st.container():
        ...
        with c1:
            note_html = f'<div style="margin-top:8px;font-style:italic;color:#695A62;">&ldquo;{r["note"]}&rdquo;</div>' if r.get("note") else ""
            ...
            st.markdown(
                ...
                <div style="color:#695A62;font-size:13px;margin-top:6px;">{r['requested_quantity']} {r['unit']} · {created}</div>
                {note_html}
